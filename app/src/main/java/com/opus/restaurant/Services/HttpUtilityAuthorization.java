...
/**
 * Created by opus on 11/30/2016.
 */
public class HttpUtilityAuthorization {
     ...
     * @throws IOException
     */
    public HttpUtilityAuthorization(String requestURL) throws IOException {
    ...
    public HttpUtilityAuthorization(String requestURL, ArrayList<KeyValue> params) throws IOException {
     ...
     //  httpConn.setRequestProperty("Authorization",token);
        ...
        //bos.write((this.twoHyphens + this.boundary + this.twoHyphens + this.crlf).getBytes());
       // bos.close();
