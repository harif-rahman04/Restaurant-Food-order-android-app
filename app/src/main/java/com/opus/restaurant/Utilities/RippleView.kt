package trip.yen.com.yentrip.UIUtility
...
class RippleView : RelativeLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, resources.getColor(R.color.colorWhite))
    ...
    override fun draw(canvas: Canvas) {
        ...
        if (animationRunning) {
            ...
            canvas.drawCircle(x!!.toFloat(), y!!.toFloat(), radiusMax * (timer.toFloat() * frameRate / rippleDuration), paint!!)
    ...
    private fun getCircleBitmap(radius: Int): Bitmap {
        ...
        val paint = Paint()
        val rect = Rect((x!!.toFloat() - radius).toInt(), (y!!.toFloat() - radius).toInt(), (x!!.toFloat() + radius).toInt(), (y!!.toFloat() + radius).toInt())
    ...
    enum class RippleType private constructor(internal var type: Int) {
        SIMPLE(0),
        DOUBLE(1),
        RECTANGLE(2)
    }
